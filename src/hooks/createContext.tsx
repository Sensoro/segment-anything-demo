...
interface contextProps {
  ...
  model: [
    ...
    setModel: React.Dispatch<React.SetStateAction<InferenceSession | null>>
  ];
  multiMaskModel: [
    multiMaskModel: InferenceSession | null,
    setMultiMaskModel: React.Dispatch<
      React.SetStateAction<InferenceSession | null>
    >
  ];
  tensor: [
    tensor: Tensor | null,
    setTensor: React.Dispatch<React.SetStateAction<Tensor | null>>
  ];
  hasClicked: [
    hasClicked: boolean,
  ...
  mask: [
    mask: maskProps,
    setMask: React.Dispatch<React.SetStateAction<maskProps>>
  ];
  modelScale: [
    modelScale: modelScaleProps | null,
    setModelScale: React.Dispatch<React.SetStateAction<modelScaleProps | null>>
  ];
