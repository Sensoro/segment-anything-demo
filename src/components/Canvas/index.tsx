...
// const { Circle, Image, Layer, Path, Rect, Ring, Stage } = require('react-konva')
import {
...
const Canvas = memo(
  ({
    ...
    const animateAllSvg = () => {
      console.log("animateAllSvg");
      console.log(didShowAMGAnimation);
      console.log(konvaRef);
    ...
    useEffect(() => {
      if (isHovering && clicks && clicks.length == 1) {
        console.log("isHovering setShouldShowAnimation");
        console.log(clicks);
